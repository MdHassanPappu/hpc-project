...
OUTPUT_FILE="$HOME/hpc-project/log/aion-placement.txt"
LAT_CSV="$HOME/hpc-project/log/latency_aion.csv"
BW_CSV="$HOME/hpc-project/log/bandwidth_aion.csv"
...
# declare -A CPU_MASKS=(
#     [same_numa]="0,2"
#     [diff_numa_same_socket]="0,1"
#     [diff_socket_same_node]="0,1"
# )
